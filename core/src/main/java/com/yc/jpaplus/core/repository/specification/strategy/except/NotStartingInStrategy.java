 ...
 */
public class NotStartingInStrategy implements IExceptStrategy {
    @Override
    public Specification except(DtoFieldWrapper wrapper) {
        ...
        if (value instanceof List) {
            ...
            if (list.size() > 0) {
                ...
                IExceptStrategy exceptStrategy = ExceptStrategyFactory.getExceptStrategy(Operator.NOT_STARTING);
                for (String str : list) {
